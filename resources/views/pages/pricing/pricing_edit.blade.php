            ...
            <div class="card shadow p-5">
                ...
                <form action="{{route('pricing.update')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">         
                            <input type="text" class="form-control form-control-user" name="desc" value="{{$item->desc}}">
                            @error('desc')
                            <span class="text-danger">{{$message}}</span>
                           @enderror
                        </div>
                    ...
                    <div class="form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control form-control-user" name="price"value="{{$item->price}}">
                            @error('price')
                            <span class="text-danger">{{$message}}</span>
                           @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls" >
                            <input type="text" name="advantage" class="form-control" value="{{$item->advantage}}" data-role="tagsinput">
                            @error('advantage') 
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls" >
                            <input type="text" name="disadvantage" class="form-control" value="{{$item->disadvantage}}" data-role="tagsinput">
                            @error('disadvantage') 
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control form-control-user" name="msg_txt" value="{{$item->msg_txt}}">
                            @error('msg_txt')
                            <span class="text-danger">{{$message}}</span>
                           @enderror
                        </div>
