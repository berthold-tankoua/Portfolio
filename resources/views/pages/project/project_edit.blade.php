                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls" >
                                            <input type="text" name="sub" class="form-control" value="{{ $project->sub}}">
                                            @error('sub') 
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls" >
                                            <input type="text" name="ytb_link" class="form-control" value="{{ $project->ytb_link}}">
                                            @error('ytb_link') 
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="controls" >
                                            <input type="text" name="client_contact" class="form-control" value="{{ $project->client_contact }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select name="status" class="form-control"  required oninvalid="this.setCustomValidity('Selectionner une categorie')" oninput="this.setCustomValidity('')">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls" >
                                            <input type="text" name="tools" class="form-control" value="{{ $project->tools }}" data-role="tagsinput">
                                            @error('tools') 
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select name="category_id" class="form-control"  required oninvalid="this.setCustomValidity('Selectionner une categorie')" oninput="this.setCustomValidity('')">
                                                ...
                                                <option value="{{ $project->category_id }}" selected>{{ $project->category->name }}</option>
                            ...
                            <div class="row"> <!-- start 7th row  -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="title1" class="form-control" value="{{ $project->title1 }}">
                                            @error('title1')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div> 
                            ...
                            <div class="row"> <!-- start 7th row  -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <h5> Titre  <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="title2" class="form-control" value="{{ $project->title2 }}">
                                            @error('title2')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div> 
                            ...
                            <div class="row"> <!-- start 7th row  -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <h5> Titre  <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="title3" class="form-control" value="{{ $project->title4 }}">
                                            @error('title3')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div> 
                            ...
                            <div class="row"> <!-- start 7th row  -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <h5> Titre  <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="title4" class="form-control" value="{{ $project->title4 }}">
                                            @error('title4')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div> 
