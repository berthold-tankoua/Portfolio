                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls" >
                                            <input type="text" name="name" class="form-control" placeholder="Titre du projet">
                                            @error('name') 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls" >
                                            <input type="text" name="sub" class="form-control" value="Service | Site Web | Immobilier">
                                            @error('sub') 
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls" >
                                            <input type="text" name="ytb_link" class="form-control" placeholder="Youtube Link">
                                            @error('ytb_link') 
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="controls" >
                                            <input type="text" name="start_date" class="form-control" placeholder="Date debut">
                                            @error('start_date') 
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="controls" >
                                            <input type="text" name="end_date" class="form-control" placeholder="Date Fin">
                                            @error('end_date') 
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="controls" >
                                            <input type="text" name="client_contact" class="form-control" placeholder="Contact">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls" >
                                            <input type="text" name="tool_path" class="form-control" value="upload/tools/php.png,upload/tools/laravel.png,upload/tools/html.png,upload/tools/css.png,upload/tools/bootstrap.png,upload/tools/js.png,upload/tools/jquery.png,upload/tools/vuejs.png,upload/tools/api.png,upload/tools/database.png,upload/tools/GitLab.png,upload/tools/learning.png,upload/tools/photoshop.png,upload/tools/pwa.png,upload/tools/map.png,upload/tools/push_notif.png,upload/tools/analytics.png" data-role="tagsinput">
                                            @error('tool_path') 
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="file" id="image" name="img_perf" class="form-control">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="url" class="form-control" placeholder="Url du projet">
                                        @error('url')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                     </div>
                            ...
                            <div class="row"> <!-- start 7th row  -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="title1" class="form-control" placeholder="Titre du projet">
                                            @error('title1')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div> 
                            ...
                            <div class="row"> <!-- start 7th row  -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <h5> Titre  <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="title2" class="form-control" value="Challenge & Solution">
                                            @error('title2')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div> 
                            ...
                            <div class="row"> <!-- start 7th row  -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <h5> Titre  <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="title3" class="form-control" value="Outils & Technologies">
                                            @error('title3')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div> 
                            ...
                            <div class="row"> <!-- start 7th row  -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <h5> Titre  <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="title4" class="form-control" value="Resultat">
                                            @error('title4')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div> 
