                ...
                <form action="{{route('formation.update')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control form-control-user" name="duration" value="{{$item->duration}}">
                            @error('duration')
                            <span class="text-danger">{{$message}}</span>
                          @enderror
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <input type="file" class="form-control form-control-user" name="image" value="{{$item->image}}">
                            @error('image')
                            <span class="text-danger">{{$message}}</span>
                           @enderror
