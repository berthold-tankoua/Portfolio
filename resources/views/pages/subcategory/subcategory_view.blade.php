			...
			<div class="col-7">
				<div class="box">
					<div class="box-header">						
						<h4 class="box-title">SubCategorie Liste <span class="badge badge-danger badge-pill">{{ count($subcategories) }}</span></h4>
					</div>
					<div class="box-body">
						<div class="table-responsive">
							<table id="complex_header" class="table table-striped table-bordered display" style="width:100%">
								...
								<tbody>
									...
									<tr>
										<td><img src="{{ $item->img_url }}" alt="category image" style="width: 40px; height: 40px;"></td>
										<td>{{$item->category->name}}</td>
										<td>{{$item->name}}</td>
										<td width="20%" style="text-align: center !important;">
                                         <a href="{{route('subcategory.edit',$item->id)}}" class="btn btn-info" style="margin-bottom: 5px;" ><i class="fa fa-edit"></i></a>
